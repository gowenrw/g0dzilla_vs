...
echo "Install ESP32 core" |tee -a arduino_cli_setup.log
echo "##########" >>arduino_cli_setup.log

echo "arduino-cli --config-file ./arduino-cli.yml core search esp32 -a" |tee -a arduino_cli_setup.log
arduino-cli --config-file ./arduino-cli.yml core search esp32 -a >>arduino_cli_setup.log 2>&1
echo "##########" >>arduino_cli_setup.log

echo "arduino-cli --config-file ./arduino-cli.yml core install esp32:esp32@2.0.17" |tee -a arduino_cli_setup.log
arduino-cli --config-file ./arduino-cli.yml core install esp32:esp32@2.0.17 >>arduino_cli_setup.log 2>&1
echo "##########" >>arduino_cli_setup.log
